...
class assignclasses(ctk.CTkScrollableFrame):
    def __init__(self, master, height, width, data, **kwags):
        ...
        label=ctk.CTkButton(upperbar,text="Assign Class", corner_radius=0)
        ...
        lbh=ctk.CTkLabel(headerframe, text="Assign")
        ...
        lbid=ctk.CTkLabel(sec1, text="Exam Name :", width=100)
        ...
        lbdate=ctk.CTkLabel(sec1, text="Class Name :", width=100)
        ...
        lbh=ctk.CTkLabel(headerframe, text="Assigned Classes")
        lbh.pack(padx=0, pady=0, fill="y", side="left")
        
        line=ctk.CTkFrame(self, height=1.5, width=width, fg_color="#DADADA")
        line.pack(padx=0, pady=0, fill="y")
        
        headings2=("id", "Exam", "Class")
