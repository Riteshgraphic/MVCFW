...
class sessionss(ctk.CTkScrollableFrame):
    def __init__(self, master, height, width, data, **kwags):
        ...
        label=ctk.CTkButton(upperbar,text="Session", corner_radius=0)
        ...
        lbh=ctk.CTkLabel(headerframe, text="Add Session")
        ...
        lbid=ctk.CTkLabel(sec1, text="Ssession Name :", width=100)
        ...
        lbdate=ctk.CTkLabel(sec1, text="Start Date :", width=100)
        ...
        lbdate=ctk.CTkLabel(sec1, text="End Date :", width=100)
        lbdate.pack(padx=10, pady=0, fill="x", side="left")
        ...
        lbh=ctk.CTkLabel(headerframe, text="All Sessions")
        lbh.pack(padx=0, pady=0, fill="y", side="left")
        
        line=ctk.CTkFrame(self, height=1.5, width=width, fg_color="#DADADA")
        line.pack(padx=0, pady=0, fill="y")
        
        headings2=("id", "Session", "Start", "End")
        
        tdata2 = []
        if data.get("data"):
            for info in data.get("data"):
                tdata2.append([info.id, info.name, info.password, info.password])
