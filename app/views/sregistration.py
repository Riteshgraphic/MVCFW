...
class registration(ctk.CTkScrollableFrame):
    def __init__(self, master, height, width, data, **kwags):
        ...
        lbh=ctk.CTkLabel(headerframe, text="Guardian's Details")
        lbh.pack(padx=0, pady=0, fill="y", side="left")
        ...
        lbftname=ctk.CTkLabel(sec7, text="Relation :", width=100)
        lbftname.pack(padx=10, pady=0, fill="x", side="left")
        ...
        lbftqual=ctk.CTkLabel(sec8, text="Qualification :", width=100)
        lbftqual.pack(padx=10, pady=0, fill="x", side="left")
 
        inftqual=ctk.CTkEntry(sec8, fg_color="#eeeeee", border_width=0, border_color="#000000", corner_radius=0, width=150) 
