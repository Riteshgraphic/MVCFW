...
class exams(ctk.CTkScrollableFrame):
    def __init__(self, master, height, width, data, **kwags):
        ...
        label=ctk.CTkButton(upperbar,text="Exam", corner_radius=0)
        ...
        lbh=ctk.CTkLabel(headerframe, text="Add Exam")
        ...
        lbdate=ctk.CTkLabel(sec1, text="Session :", width=100)
        ...
        lbh=ctk.CTkLabel(headerframe, text="All Exams")
        lbh.pack(padx=0, pady=0, fill="y", side="left")
        
        line=ctk.CTkFrame(self, height=1.5, width=width, fg_color="#DADADA")
        line.pack(padx=0, pady=0, fill="y")
        
        headings2=("id", "Exam", "Session")
