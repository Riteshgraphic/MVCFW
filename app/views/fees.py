...
class feeses(ctk.CTkScrollableFrame):
    def __init__(self, master, height, width, data, **kwags):
        ...
        label=ctk.CTkButton(upperbar,text="Fees", corner_radius=0)
        ...
        lbh=ctk.CTkLabel(headerframe, text="Add Fees")
        ...
        lbid=ctk.CTkLabel(sec1, text="Fees Name :", width=100)
        ...
        lbdate=ctk.CTkLabel(sec1, text="Ammount :", width=100)
