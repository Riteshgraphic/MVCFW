...
class assignsubs(ctk.CTkScrollableFrame):
    def __init__(self, master, height, width, data, **kwags):
        ...
        label=ctk.CTkButton(upperbar,text="Assign Subject", corner_radius=0)
        ...
        lbdate=ctk.CTkLabel(sec1, text="Subject Name :", width=100)
